...
export default function Home() {
  ...
  const calculate = () => {
    ...
    if (!billValue || billValue <= 0 || !tipPercent) return;
  ...
  const isDisabled = !bill || bill <= 0 || !tipPercent;
    ...
    <div className="min-h-screen flex items-center justify-center p-6
      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="bg-white rounded-2xl text-center py-4 mb-6 
          font-semibold text-lg shadow-md text-pink-500">
          Tip Calculator
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl flex overflow-hidden">
          ...
          <div className="w-1/2 p-8">
            ...
            <label className="block font-semibold mb-3 text-sky-500">
              Tip Percentage
            </label>
          ...
          <div className="w-1/2 p-8 bg-gradient-to-b from-sky-200 to-pink-200 
            ...
            <button
              ...
              py-3 rounded-2xl hover:bg-pink-50 transition shadow-sm"
            >
              Reset
            </button>
          </div>
